...
$params = [];
$params["token"] = "XXXXXXX"; // log in user.4jawaly.com -> whatsapp -> ارسال رسالة -> API Docs
$params["phone"] = "19292439373";
$params["body"] = "https://i0.wp.com/www.4jawaly.com/wp-content/uploads/2019/05/itservice2_pic2.png";  //Message text, UTF-8
...
$params["sendMediaAsSticker"] = 1;
$params["filename"] = "photo_name.png"; //تظهر لدى المستلم
$params["stickerName"] = "4jawaly sticker";
...
curl_setopt_array($curl, array(
    CURLOPT_URL => $domain.'api/v1/message/file',
