...
$params = [];
$params["token"] = "XXXXXXXXX"; // log in user.4jawaly.com -> whatsapp -> ارسال رسالة -> API Docs
$params["phone"] = "19292439373";
$params["body"] = "https://cdn-dev.4jawaly.com/spam-regulation.pdf";  //PDF ,xlsx  url
...
$params["filename"] = "filename.pdf"; // ,pdf or .xlsx
